...
describe('TokenFactory', () => {
    ...
    it('should deploy', async () => {
        ...
        // blockchain and tokenFactory are ready to use
    });
    ...
    it('should increase counter', async () => {
        ...
        for (let i = 0; i < increaseTimes; i++) {
            ...
            const increaseResult = await tokenFactory.sendIncrease(increaser.getSender(), {
                increaseBy,
                value: toNano('0.05'),
            });
            ...
            const counterAfter = await tokenFactory.getCounter();
